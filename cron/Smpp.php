...
class smpp {
  ...
  //////////////////////////////////////////////////
  function submit_sm($source_addr,$destintation_addr,$short_message,$optional='',$response = false) {
...
//    return ($ret['status']==0);
  ...
  //////////////////////////////////////////////////
  function send_long($source_addr,$destintation_addr,$short_message,$utf=0,$flash=0, $response = false) {
    ...
    if ($size<160) { // Only one part :)
      $stateSMS = $this->submit_sm($source_addr,$destintation_addr,$short_message,'',$response);
//      if ($stateSMS===false)
//          return false;
      return $stateSMS;
...
//           return false;
        return $this->submit_sm($source_addr,$destintation_addr,$part,$optional, $response);
      }
    }
  ...
  *****************************************************************/
  ...
  function getError($status)
  {
      ...
      return isset($error[$status])? $error[$status]: 'Error Undefine';
  }
